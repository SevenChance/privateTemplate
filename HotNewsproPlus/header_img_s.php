...
<link rel="stylesheet" href="<?php bloginfo('template_url'); ?>/css/gallery.css" />
...
<?php endif; ?>
<script type="text/javascript" src="<?php bloginfo('stylesheet_directory'); ?>/js/jquery.min.js" ></script>
<script type="text/javascript" src="<?php bloginfo('stylesheet_directory'); ?>/js/imgplayer.js" ></script>
