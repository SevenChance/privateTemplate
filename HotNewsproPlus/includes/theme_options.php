...
//CMS布局首页设置
	...
	array(  "name" => "选择横向滚动内容",
			"desc" => "默认自定义，通过添加自定义栏目，名称：recommend，值：可任意，调用显示指定文章。",
...
//顶部热点文章设置开始
	...
	array(  "name" => "选择调用方法",
			"desc" => "默认显示4篇最新文章，选择自定义模式后，通过添加自定义栏目,名称：hot，值：可任意，调用指定的文章",
...
//"google自定义搜索
	...
	array(	"name" => "输入首页广告代码",
            ...
            "id" => $shortname."_adh_c",
            "type" => "textarea",
            "std" => '<a href="http://faq.wopus.org/" target="_blank"><img src="http://i1154.photobucket.com/albums/p534/zmingcx/ad.jpg" alt="Wopus问答" /></a>'),

	array(	"name" => "输入侧边广告代码(小工具)",
            "desc" => "",
            "id" => $shortname."_adsc",
            "type" => "textarea",
            "std" => '<a href="http://wordpress.org/" target="_blank"><img src="http://i1154.photobucket.com/albums/p534/zmingcx/wps.jpg" alt="wordpress" /></a>'),
	...
	array(	"name" => "输入正文广告代码",
            ...
            "id" => $shortname."_ad_rc",
            "type" => "textarea",
            "std" => '<a href="http://idc.wopus.org/" target="_blank"><img src="http://i1154.photobucket.com/albums/p534/zmingcx/vpsh.jpg" alt="VPS主机合租" /></a>'),
